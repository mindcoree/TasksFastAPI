...
Revision ID: 32563776fa23
Revises:
Create Date: 2025-06-07 21:23:06.180135
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("order_id", "product_id", name="pk_order_product"),
    )
